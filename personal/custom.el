(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (solarized-theme markdown-mode yaml-mode geiser company-anaconda anaconda-mode json-mode js2-mode rainbow-mode elisp-slime-nav rainbow-delimiters company helm-ag helm-descbinds helm-projectile helm clang-format cmake-mode git-gutter-fringe vkill exec-path-from-shell zop-to-char which-key volatile-highlights undo-tree smartrep smart-mode-line operate-on-number move-text magit ov imenu-anywhere guru-mode grizzl god-mode gitignore-mode gitconfig-mode git-timemachine gist flycheck expand-region epl editorconfig easy-kill diminish diff-hl discover-my-major dash crux browse-kill-ring beacon anzu ace-window)))
